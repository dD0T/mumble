...
static MumblePlugin bf1942plug = {
	...
	1,
	false,
	MumbleInitConstWideString(L"Battlefield 1942"),
	MumbleInitConstWideString(L"1.61b"),
	MumbleInitConstWideString(L"Supports Battlefield 1942. No identity or context support yet."),
	fetch,
	trylock,
	generic_unlock,
};
